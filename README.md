# Деплой проектов Kittygram и Taski на удалённый сервер

## Описание проекта

Основная задача  - деплой двух проектов на удаленный сервер.
Необходимо установить и настроить два экземпляра Nginx и два экземпляра gunicorn. Каждый экземпляр должен быть настроен на свой уникальный порт и доменное имя, чтобы обеспечить правильную маршрутизацию запросов. 

## Ссылки на развёрнутые приложения

- [Taski](https://taskme.servebeer.com)
- [Kittygram](https://kittycat.servebeer.com)
